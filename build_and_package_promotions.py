...
ROOT_DIR = "convert-promotions"   # root folder
...
subprocess.run([
    ...
    f"--add-data=promotions;promotions",
...
# Create empty promotions folder
promotions_dir = os.path.join(package_dir, "promotions")
